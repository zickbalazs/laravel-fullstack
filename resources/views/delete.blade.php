    ...
    @if (isset($data->id))
        <form action="/api/delete/{{ $data->id }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="date" disabled value="{{ $data->day }}">
            </div>
            <div class="mb-3">
                <label class="form-label">From:</label>
                <input class="form-control" type="time" disabled value="{{ $data->from }}">
            </div>
            <div class="mb-3">
                <label class="form-label">To:</label>
                <input class="form-control" type="time" disabled value="{{ $data->to }}">
            </div>
            <div class="mb-3 form-check">
                <input class="form-check-input" disabled type="checkbox" value="{{$data->done}}">
